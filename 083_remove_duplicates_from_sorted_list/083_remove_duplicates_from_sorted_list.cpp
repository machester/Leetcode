...
#define CALSS_PROTECT                   1
#define PASS_TIME_NOT_OK                0
// #include <cstring>
...
protected:
    // list_init protect, can not direct create list
...
int main() 
{
    ...
    Solution solution;
    list_node * lls = solution.list_init();
...
list_node * Solution::list_init(void)
{
    return Solution::list_head_init();
}
